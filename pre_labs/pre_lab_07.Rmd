...
#a6c52a286768812eef0f14c279339ee7d19b30a9
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Nevada had the largest percentage change of 35.1%**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Estimate of Household income in Maryland**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **The average household income for high schools that have 60% or more graduates immediately enrolling in college, is $69,252.24**
...
**Task** What is another question you could ask of this data? **How many graduates did not enroll college due to income?**
