...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **This code is joining the month with the total calls for that month in descending order**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Blank space**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **a bar chart with the 911 calls by month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The months are reordered from lowest to highest by calls**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The chart is flip horziontally, so the months are on the y axis and the count is on the x axis**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **theme_minimal has been added to the codeblock**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **the theme of the chart has changed to a light blue background and white lines **
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The axis titles have changed to match the data being shown.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Dates in chronological order with the total number of calls for that date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A line chart; looks like a EKG a little bit**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **the x axis is all jumbled together making it hard to read**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **the x axis is slanted so all of the data can fit. Still a little jumbled but i can still read it**
