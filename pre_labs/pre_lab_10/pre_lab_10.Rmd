...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **There are 8 columns that are ObjectId, Zipcode, Existing, Shape, geometry, and zip name**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **a table with Maryland cities and their zip codes and how big they are.**
...
**Task** Run the following code. Describe the output in the space below. **It showed a map of Maryland separated by cities with coordinates.**
...
**Task** Run the following code. Describe the output in the space below. **It says, "To enable caching og data, set 'options(tigris_use_cache = TRUE)' in your R scripy or .Rprofile.**
...
**Task** Run the following code. Describe the output in the space below. **It's now 19 columns that are labled State, County, GEIOD, NAAME, LSAD, CLASSFP, etc. Bit of an eye sore to look at.**
...
**Task** Run the following code. Describe the output in the space below. **The table filterd the STATEFP to only show 24, which only showed the respective data**
...
**Task** Run the following code. Describe the output in the space below. **It's the Maryland map separated by counties.**
...
**Task** Run the following code. Describe the output in the space below. **It's the Maryland map separated by county and zip codes**
...
**Task** Run the following code. Describe the output in the space below. **It's only two colums: 'zip' and 'march_2023'**
...
**Task** Run the following code. Describe the output in the space below. **'march_2023' got joined with the 'counties' table**
...
**Task** Run the following code. Describe the output in the space below. **It's the Maryland map separated by zip codes, but this time it's color coded with a legend based on 'march_2023'**
...
library(janitor)
library(tidycensus)
#census_api_key("a6c52a286768812eef0f14c279339ee7d19b30a9")
```
...
**Task** Run the following code. Describe the output in the space below. **It's a table with foreclosures from July 2021-March 2021 by zip code**
...
**Task** Run the following code. Describe the output in the space below. **It's a table separated by GEOID, NAME, variable, estimate, moe and geometry**
...
**Task** Run the following code. Describe the output in the space below. **It's a table with the day and time, type of foreclosure, county, and notices.**
...
**Task** Run the following code. Describe the output in the space below. **The data was cleaned to change a column name so it's easier to join**
...
**Task** Run the following code. Describe the output in the space below. **The tables were joined so now there's 'county population', 'date', 'type notices', and 'geometry'**
...
**Task** Run the following code. Describe the output in the space below. **There's a new column labled 'rate' and it has the rate of foreclsure notices per 1000 population**
...
**Task** Run the following code. Describe the output in the space below. **It's the Maryland map separated by county and color coded, and is now labeled with the county names **
...
**Task** Run the following code. Describe the output in the space below. **The map is still separated by counties but is now colorcoded differently, meaning instead of different shades of blue it's pink, purple, black, ad biege to show the difference.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Pink has been changed to orange and the legend has changed from '2.0' to '2.00000000'**
