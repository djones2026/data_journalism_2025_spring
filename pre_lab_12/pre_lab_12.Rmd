...
Let's suppose we can't find a table like that for download, but we do see a version on the website at this URL: <https://news.maryland.gov/msde/category/newsreleases/>.
...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **The results are from recent to latestr**
...
```{r}
osp_url <- "https://news.maryland.gov/msde/category/newsreleases/"
```
...
tags. Describe the output: **There is a list rather than the code for the list**
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **There is a table of date and title**
